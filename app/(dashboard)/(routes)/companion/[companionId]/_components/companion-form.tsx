...
import { ImageUpload } from "@/components/pdf/image-upload";
...
const formSchema = z.object({
  ...
  companionCategoryId: z.string().min(1, {
    message: "Category is required",
  }),
});

interface CompanionFormProps {
  companionCategories: CompanionCategory[];
