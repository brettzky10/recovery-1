...
// imports
import type { programType } from '@/lib/step-types.h'
import eyeAnimation from '@/public/animations/eye.json';
import stringAnimation from '@/public/animations/strong.json';
import fruitsAnimation from '@/public/animations/fruits.json';
import sleepAnimation from '@/public/animations/sleep.json';
        ...
        <div className="flex items-center gap-6">
          <div className="flex flex-col gap-8">
            {data.overview.problem_roles.map((elt) => (
              <div key="elt" className="flex flex-col gap-1">
                  ...
                  <TableCell>
                    <span className="flex flex-col">
                      {meal.examples.map((elt) => (
                        <TableCell key={elt}>{elt}</TableCell>
                      ))}
                    </span>
                  </TableCell>
                </TableRow>
