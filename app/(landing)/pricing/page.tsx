...
import UpgradeButton from '@/components/pdfchat/upgrade-button'
  ...
  return (
    <>
      <MaxWidthWrapper className='mb-8 mt-24 text-center max-w-5xl'>
        ...
        <div className='pt-12 grid grid-cols-1 gap-10 lg:grid-cols-2 pb-20'>
          <TooltipProvider>
            {pricingItems.map(
              ({ plan, tagline, quota, features }) => {
                ...
                return (
                  <div
                    ...
                    <div className='p-5'>
                      <h3 className='my-3 text-center font-display text-3xl font-bold text-gray-800'>
                        {plan}
                      </h3>
                      <p className='text-gray-500'>
                        {tagline}
                      </p>
                      <p className='my-5 font-display text-6xl font-semibold text-gray-800'>
                        ${price}
                      </p>
                      <p className='text-gray-500'>
                        per month
